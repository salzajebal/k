...
export const lawyers: Lawyer[] = [
  {
    name: "이상혁 대표변호사",
    title: "화민 대표변호사 · 사법연수원 42기",
    image: "lawyer-rep.png",
    quote: "의뢰인의 상황을 제 일처럼 살펴, 가장 확실한 해결책을 찾아드립니다.",
    intro:
      "채무 문제는 혼자 감당하기 버거운 일입니다. 화민 이상혁 대표변호사는 개인회생·개인파산·신용회복 사건을 중심으로, 의뢰인이 다시 일상으로 돌아갈 수 있도록 처음 상담부터 사건 종결까지 직접 챙깁니다. 서류 준비의 어려움부터 법원 절차의 부담까지, 전 과정을 명확하게 안내해드립니다.",
...
export const businessInfo = {
  ...
  address: "경기도 고양시 일산동구 중앙로 1197, 801호(장항동)",
  tel: "031-994-8731",
  fax: "031-994-8732",
};
