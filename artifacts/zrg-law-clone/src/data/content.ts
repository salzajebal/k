...
export const youtubeSlideGroups: YoutubeVideo[][] = [
  [
    {
      seq: 1,
      href: "https://youtu.be/wl3UMpoLMVs?si=7SM259C3hV7ID6o6",
      image: "main_youtube_img1.jpg",
      title: "50대 지옥같던 돌려막기는 끝",
      caption: "자영업 접고 진 빚 4,600만 원\n개인회생으로 71% 감면 받은 50대 직장인 후기",
    },
    {
      seq: 3,
      href: "https://youtu.be/uAPQ4WxpXeQ?si=WgaaG-Rc2_QQbDSP",
      image: "main_youtube_img2.png",
      title: "40대 직장인 쉬는 날 없이 일했습니다",
      caption: "'월급 180만원으로 어떻게 갚나 싶었죠'\n1억 빚 88% 탕감 개인회생 후기",
    },
    {
      seq: 8,
      href: "https://youtu.be/y019C6rNvUM?si=XaP9WVS50b_Pwq3x",
      image: "main_youtube_img3.png",
      title: "20대 전세사기, 이 서류는 발급하세요",
      caption: "'1억 빚을 20년 안에 갚을 수 있을까?'\n20대 직장인 서울 전세사기 개인회생 후기",
    },
  ],
  [
    {
      seq: 5,
      href: "https://youtu.be/x6gkeQ8zwho?si=g4MRRt_u9bmRZzaD",
      image: "main_youtube_img4.jpg",
      title: "투잡뛰며 버틴 50대 자영업자",
      caption: "'이제 2천만원 남았어요'\n개인회생 빚 1억 7천 83% 감면 현실후기",
    },
    {
      seq: 6,
      href: "https://youtu.be/EIZejqK7bfY?si=UOy4cHjOmlFOyQMJ",
      image: "main_youtube_img5.png",
      title: "50대 투자사기 월급날이 무섭지 않아요",
      caption: "지인 빚 떠안다 투자사기까지?\n50대 직장인 빚 6,800만 원 개인회생 후기",
    },
    {
      seq: 7,
      href: "https://youtu.be/jEhHfrUOgjc?si=qqjXCHk3_Acpfo7r",
      image: "main_youtube_img6.jpg",
      title: "30대 회생 폐지 후 2차 회생 간 후기",
      caption: "자영업자 출신 30대 직장인 개인회생 후기\n'사업 두 번 접었는데 빚 1억이 됐습니다'",
    },
  ],
  [
    {
      seq: 9,
      href: "https://youtu.be/wNfvgzbNPPo?si=AQcYKxCTCy9L0mLJ",
      image: "main_youtube_img7.jpg",
      title: "30대 에코프로 최점때 영끌 매수 후 손실",
      caption: "리딩방 사기 피해와 급등주 투자 손실이 겹친\n30대 직장인 개인회생 후기",
    },
    {
      seq: 10,
      href: "https://youtu.be/gbZ4CSyO0-k?si=62V76qRjogGYwak9",
      image: "main_youtube_img8.jpg",
      title: "개인회생 vs 새출발기금 비교상담 후기",
      caption: "'사기때문에 3,600만 원 빚이 있었어요'\n7만 유튜버 '콜라병'님의 솔직 리뷰",
    },
    {
      seq: 11,
      href: "https://youtu.be/EWPj2W9iaAo?si=FTFKy8eKgqlcKAoq",
      image: "main_youtube_img9.png",
      title: "50대 월급이 다 토토에 갔어요",
      caption: "도박으로 월급을 다 써버린 50대 직장인\n7천만 원 빚 73% 탕감 후기",
    },
  ],
];
...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answerHtml:
      ...
      "파산신청하는 곳을 찾고 계신다면 지름길 법무법인에서 전국 상담을 제공합니다.",
  ...
  },
  {
    ...
    answerHtml:
      ...
      "<strong>개인회생 사건번호 조회</strong>는 대법원 전자소송 사이트 또는 신용정보원에서 가능하며, 담당 사무원이 진행 상황을 직접 조회·안내해드립니다.<br><br>개인프리워크아웃(연체 90일 미만)이나 개인워크아웃조건에 해당하는 경우 신용회복위원회뿐만 아니라, 지름길 법무법인에서도 나에게 유리한 채무조정제도가 무엇인지 비교해보실 수 있습니다.",
    cta: [
